...
import com.esprit.app1.MyApplication;
import com.esprit.entity.Categorie;
import com.esprit.entity.Question;
import com.esprit.entity.Reponse;
import com.esprit.service.QuestionService;
import com.esprit.service.ReponseService;
import com.esprit.service.reponse_like_Service;
...
//        aff.show();
        ...
        dislike.addActionListener(e-> {
            reponse_like_Service.getInstance().addreactiondislike(idd);  
         nbrr+=1;
