...
public class CategorieService {
 ...
 public boolean resultOK;
   ...
   public ArrayList<Categorie> getListVelo(){
        String url = Statics.BASE_URL+"/categorie/listC";
        req.setUrl(url);
        req.setPost(false);
   ...
   public boolean addcat(Categorie v) {
        String url = Statics.BASE_URL + "/categorie/newCategorieM?nameCategorie=" + v.getNameCategorie()+ "&tagC=" + v.getTag(); //création de l'URL
