...
public class CommandeService {
   ...
   public boolean addvelo(int id, Commande c) {
        String url = Statics.BASE_URL + "/commande/commandeajoutmobile"+id+"?modepaiement=" +c.getModepaiement()+ "&address=" + c.getAddressecom()+ "&num=" + c.getNumtel()+ "&mail=" + c.getMail(); //création de l'URL
       ...
       public void ajouterpanier(int id){
        String url = Statics.BASE_URL+"/panier/add/"+id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
           @Override
...
public ArrayList<ProduitM> getlistpanier(){
        String url = Statics.BASE_URL+"/panniermobile";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
 ...
 public boolean supprimerpanier(int id) {
        String url = Statics.BASE_URL +"/removemobile/"+id; //création de l'URL
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
