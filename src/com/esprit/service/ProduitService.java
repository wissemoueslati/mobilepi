...
public class ProduitService {
 ...
 public static ProduitService getInstance() {
  ...
  public ArrayList<ProduitM> getListProduit(){
        String url = Statics.BASE_URL+"/listproduitmobile";
        req.setUrl(url);
        req.setPost(false);
  ...
  public ProduitM getListProduit_by_id(int id){
        String url = Statics.BASE_URL+"/det_prod"+id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
   ...
   public ArrayList<ProduitM> searchproduit(String value ){
        ...
        String url = Statics.BASE_URL+"/recherchemobile/mahmoud?searchValue="+value;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
