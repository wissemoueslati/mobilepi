...
public class commentaireService {
       private ConnectionRequest req;
        ...
        String url= DataSource.BASE_URL+"/mobile/Ajouc?=contenu="+contenu.getText()+"&name="+name.getText()+"&email="+email.getText();
     ...
     NetworkManager.getInstance().addToQueueAndWait(req);
          ...
          public ArrayList <blogcomment> afficheblogs (){
        ArrayList <blogcomment> result =new ArrayList <>();
        req=new ConnectionRequest();
        String url= DataSource.BASE_URL+"/mobile/Blogcomment";
