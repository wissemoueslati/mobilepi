 ...
 public static QuestionService instance=null;
  public boolean resultOK;
   ...
   public ArrayList<Question> getListQuestion(int id){
        String url = DataSource.BASE_URL+"/question/listQ/"+id;
        req.setUrl(url);
        req.setPost(false);
      ...
      public boolean addques(Question v,int id) {
        String url = DataSource.BASE_URL + "/question/newQuestionM/"+id+ "?question=" + v.getQuestion()+ "&tagQ=" + v.getTag(); //création de l'URL
